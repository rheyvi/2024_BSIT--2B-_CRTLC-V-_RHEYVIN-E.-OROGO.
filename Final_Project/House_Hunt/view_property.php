         ...
         <div class="menu">
            <ul>
               <li><a href="#">Help<i class="fas fa-angle-down"></i></a>
                  ...
                  <li> <a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Your Cart</a></li>
                  </ul>
               </li>
            </ul>
         </div>
   ...
   <?php
      ...
      if ($result->num_rows > 0) {
         while($row = $result->fetch_assoc()) {
            ...
            echo "<br>";
            echo "<h5>Sale: " . $row['dp_percentage'] . "</h5>";
            echo "<br>";
            echo "<h5>Year: " . $row['yearduration'] . "</h5>";
            echo "<br>";
            echo "<h5>Monthly Payment: " . $row['monthly_payment'] . "</h5>";
            echo "<br>";
            echo "<br>";
            echo "<pre><h5>Description: <br>
            To calculate your monthly payment, we take the total price of your purchase, subtract your down payment, 
            then apply our annual interest rate which is 0.05 per Year. This amount is divided into equal monthly 
            payments over the duration of your loan term, providing you with a clear and manageable monthly payment plan
            </h5></pre>";
            echo "<button class='buy-btn' onclick=\"window.location.href='payment_user_form.php?houseId=" . $row['houseId'] . "'\">Buy</button>"; //Buy Button
            echo "</div>";
         }
      } else {
